...
const PrivacyPageComponent = () =>
    <div className="container">
        <div>
            <h1 className="stock-heading-privacy-page center">Privacy  Page</h1>
            <p className= "stock-content-privacy-page">Privacy is a fundamental human right that many governments from all over the world recognize. There are numerous legislations made to support and protect an individual’s right to have their personal data kept a secret if they choose not to divulge their information.
        ...
        <span className="d-flex justify-content-center">
            <Link to={"/stockPal/home"}>
        <button
            className="btn btn-primary stock-button-privacy-page-accept">
            Accept
        </button>
                 </Link>
            <Link to={"/stockPal/home"}>
        <button className="btn btn-danger stock-button-privacy-page-reject">
            Reject
        </button>
                </Link>
             </span>
